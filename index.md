...
<style>
  /* Accessibility and High Contrast Overrides */
  :root {
    --text-dark: #1a1a1a;
    --bg-light: #ffffff;
    --link-blue: #0056b3;
    --link-hover: #003d82;
    --focus-ring: #d946ef; /* High contrast magenta for visibility */
    --border-color: #767676; /* WCAG compliant border contrast */
  }
  ...
  /* Robust Focus Indicators for Tab Navigation */
  ...
  /* Screen Reader Only Class for Skip Link */
  .sr-only {
    position: absolute;
    width: 1px;
    height: 1px;
  ...
  ul.team-list, ul.resource-list, ul.references {
    list-style: none;
    padding-left: 0;
    margin-top: 1rem;
  }

  ul.team-list li, ul.resource-list li, ul.references li {
...
<ul class="team-list">
  <li>
    <strong><a href="https://www.unr.edu/cse/people/david-feil-seifer">Dave Feil-Seifer</a></strong> <br/>
    Advisor | University of Nevada, Reno
  </li>

  <li>
    <strong>Vinh Le</strong> <br/>
    Instructor | University of Nevada, Reno
  </li>

  <li>
    <strong><a href="https://www.unr.edu/cse/people/emily-hand">Emily Hand</a></strong> <br/>
